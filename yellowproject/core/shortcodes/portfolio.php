        ...
        function shortcode_portfolio($atts, $content = null)
        {
            ...
            echo '
				...
				<div class="load_more_cont">';
                    echo '<a class="btn_load_more get_portfolio_works_btn" href="#">' . ((get_theme_option("translator_status") == "enable") ? get_text("translator_load_more") : __('Load more works','theme_localization')) . '<span></span></a>';
            echo '
			    </div>
            ';
            ?>
