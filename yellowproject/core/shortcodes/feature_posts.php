                ...
                if ($post_type == "port") {
                    ...
                    while ($wp_query->have_posts()) : $wp_query->the_post();
                        ...
                        if (strlen($featured_image[0]) > 0) {
                            $featured_image_url = TIMTHUMBURL . "?w=270&h=163&src=" . $featured_image[0];
                            $full_image_url = $featured_image[0];
                        } else {
                            $featured_image_url = TIMTHUMBURL . "?w=270&h=163&src=" . IMGURL . '/core/featured_image.jpg';
                            $full_image_url = TIMTHUMBURL . "?w=270&h=163&src=" . IMGURL . '/core/featured_image.jpg';
                        }
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="carousel_desc">
                                        <div class="exc">' . smarty_modifier_truncate(get_the_excerpt(), 105) . '</div>
                                    </div>
                                </div>
                            </li>
                        ';
                        ...
                        if ($post_type == "post" && $related !== "yes") {
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="carousel_desc">
                                        <div class="exc">' . smarty_modifier_truncate($recent["post_content"], 100) . '</div>
                                    </div>
                                </div>
                            </li>
                        ';
                        ...
                        if ($post_type == "port" && $related !== "yes") {
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="carousel_desc">
                                        <div class="exc">' . smarty_modifier_truncate($recent["post_excerpt"], 105) . '</div>
                                    </div>
                                </div>
                            </li>
                        ';
