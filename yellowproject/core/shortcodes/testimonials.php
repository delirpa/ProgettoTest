                            ...
                            <li>
                                <div class='item'>
                                    <div class='testimonials_photo'>
                                        ".(strlen($featured_image[0])>0 ? "<img src='".TIMTHUMBURL."?w=80&h=80&src=$featured_image[0]' class='testimonials_ava grey_img'>" : "<img src='".TIMTHUMBURL."?w=80&h=80&src=".IMGURL."/core/testimonials.jpg'  class='testimonials_ava grey_img'>")."
                                    </div>
