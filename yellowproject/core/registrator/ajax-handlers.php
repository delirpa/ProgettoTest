        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
            ...
            if ($html_template == "1 column") {
                ...
                <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element row-fluid">
                    ...
                    <div class="filter_img span6">
                        <a '.$target.' href="' . $linkToTheWork . '" class="ico_link"><img src="' . TIMTHUMBURL . '?w=570&amp;h=400&amp;src=' . $featured_image[0] . '" alt="' . get_the_title() . '" width="570" height="400"></a>
                ...
                <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element">
                    <div class="filter_img">
                        <a '.$target.' href="' . $linkToTheWork . '">
                            <img src="' . TIMTHUMBURL . '?w=570&amp;h=400&amp;src=' . $featured_image[0] . '" alt="' . get_the_title() . '" width="570" height="400">
                            <span class="post_type post_type_'.$pf.'"></span>
            ...
            if ($html_template == "3 columns") {
                ...
                <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element">
                    <div class="filter_img">
                        <a '.$target.' href="' . $linkToTheWork . '">
                            <img src="' . TIMTHUMBURL . '?w=370&amp;h=260&amp;src=' . $featured_image[0] . '" alt="' . get_the_title() . '" width="370" height="260">
                            <span class="post_type post_type_'.$pf.'"></span>
                            <div class="portfolio_dscr">
                                <div class="wrap_padding">
                                    ' . get_the_title() . '
            ...
            if ($html_template == "4 columns") {
                ...
                <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element">
                    <div class="filter_img">
                        <a '.$target.' href="' . $linkToTheWork . '">
                        <img src="' . TIMTHUMBURL . '?w=270&amp;h=189&amp;src=' . $featured_image[0] . '" alt="' . get_the_title() . '" width="270" height="189">
                        <span class="post_type post_type_'.$pf.'"></span>
                        <div class="portfolio_dscr">
                            <div class="wrap_padding">
                                ' . get_the_title() . '
