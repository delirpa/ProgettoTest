	...
	private $template = '<div class="mix-container">
		...
		<div class="mix-tabs">
            ...
            <div class="theme_settings_submit_cont">
                <input type="submit" name="reset_theme_settings" onclick="return confirm(\'Are you sure?\') ? true : false;" class="reset_settings button danger_btn" value="Reset Settings" />
