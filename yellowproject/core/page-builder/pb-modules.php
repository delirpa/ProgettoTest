...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_input($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Thumbnail width", "image_width", "100px", "center") . "
        " . get_module_settings_part_input($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Thumbnail height", "image_height", "100px", "center") . "
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Margin-bottom", "padding_bottom", "200px", $pbconfig['available_padding_after_module']) . "
    </div>
    " . get_module_settings_part_done_btn() . "
</div>
...
<div class='pop_scrollable_area'>
    " . get_module_settings_part_heading($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig) . "
    <div class='padding-cont'>
        " . get_module_settings_part_select($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Slider #ID", "show_slider_id", "100px", $list_slide_id) . "
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Slider type", "slider_type", "200px", array("slider_type1"=>"Content", "fullscreen_slider"=>"Full width")) . "
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Margin-bottom", "padding_bottom", "200px", $pbconfig['available_padding_after_module']) . "
...
<div class='pop_scrollable_area'>
    ...
    <div class='padding-cont'>
        ...
        " . get_module_settings_part_input($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Video height", "video_height", "100px", "center") . "
        " . get_module_settings_part_select_with_caption($pagebuilder, $moduleid, $pb_module_size_now, $pbconfig, "Margin-bottom", "padding_bottom", "200px", $pbconfig['available_padding_after_module']) . "
    </div>
    " . get_module_settings_part_done_btn() . "
</div>
