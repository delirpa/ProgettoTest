...
$(document).ready(function () {
    ...
    $('.slider_type .available_media_item').live('click', function () {
        ...
        var available_media_item_this_timthumburl = $(this).find('.previmg').attr('data-timthumb-url');
    ...
    $('.bg_or_slider_option.bg_type .available_media_item').live('click', function () {
        ...
        $('.bg_or_slider_option.bg_type .preview_bg_image').fadeOut('fast', function () {
            $('.bg_or_slider_option.bg_type .preview_bg_image').delay(200).attr('src', TIMTHUMBURL + '?src=' + for_bg_data_full_url + '&w=156&h=106').fadeIn('fast');
        });
    ...
    $(".available-images-for-pf .ajax_cont .img-item").live('click', function(){
        ...
        $.post(ajaxurl, data, function (response) {
            $(".selected-images-for-pf").append("<div class='img-item append_animation style_small'><div class='img-preview'><img src='"+TIMTHUMBURL+"?src="+pffullurl+"&amp;w=62&amp;h=62' data-full-url='"+pffullurl+"' data-timthumb-url='"+TIMTHUMBURL+"?src="+pffullurl+"&amp;w=156&amp;h=106' alt='' class='previmg'><div class='hover-container'></div></div><input type='hidden' name='pagebuilder[post-formats][images]["+response+"][src]' value='"+pffullurl+"'></div>");
    ...
    $(".qsc_insert").live("click", function(){
        ...
        $(".custom_button_inserter").live("click", function(){
            ...
            $(this).parents(".edit_popup").find(".sc_inserted_here .enter_text1").val(tmp_txt_val + " " + "[custom_button style='"+custom_button_sc_type+"' href='"+custom_button_sc_address+"']"+custom_button_sc_text+"[/custom_button]");
        });
