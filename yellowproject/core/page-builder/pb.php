        ...
        echo "  </select>
            ...
            <div class='padding-cont'>
                ...
                <div class='radio_block' style='padding-top:15px;'>
                    ...
                    <div class='radio_selector'>
                        " . toggle_radio_yes_no('pagebuilder[settings][show_breadcrumb]', $pagebuilder['settings']['show_breadcrumb'], 'no') . "
                    </div>
                    <div class='help_here text-shadow1'></div>
                    <div class='clear'></div>
                </div>";
                        ...
                        <div class='padding-cont' style='padding-bottom:11px;'>
                            <div class='bg_for_this_page w2 fl'>
                                <div class='img-item'>
                                    ...
                                    <div class='img-preview'>
                                        <img class='preview_bg_image' src='" . TIMTHUMBURL . "?src={$pagebuilder['settings']['bg_image']['src']}&amp;w=156&amp;h=106' alt=''>
                                    </div>
                                </div>
                            </div>
