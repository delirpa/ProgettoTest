                ...
                <div class="row">
                    <div class="posts-block <?php echo (($pagebuilder['settings']['layout-sidebars'] == "left-sidebar" || $pagebuilder['settings']['layout-sidebars'] == "right-sidebar") ? "span9" : "span12"); ?>">
                        <div class="contentarea">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <a class="btn_back" href="javascript:history.back()"><?php (get_theme_option("translator_status") == "enable") ? the_text("back_button") : _e('Back','theme_localization'); ?><span></span></a>
                                </div>
                            </div>
